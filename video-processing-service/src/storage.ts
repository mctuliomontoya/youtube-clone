...
const rawVideoBucketName = "mt-yt-raw-videos-2910";
const processedVideoBucketName = "mt-yt-processed-videos-2910";

const localRawVideoPath = "./raw-videos";
const localProcessedVideoPath = "./processed-videos";

/**
 * Creates th local directories for raw processed videos
 */
 ...
 * @param {string} dirPath - The directory of the path to check.
 */
